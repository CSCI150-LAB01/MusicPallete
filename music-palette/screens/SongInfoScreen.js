    ...
    useEffect(() => {
        async function fetchSongs() {
            ...
            try {
                ...
                if (!response.ok) {
                    throw new Error("Failed to Fetch the Album Songs")
                }
    ...
    return (
        <LinearGradient colors={["#040306", "#1c0505"]} style={{ flex: 1 }}>
            <ScrollView style={{ marginTop: 50 }}>
                ...
                <View style={{ marginHorizontal: 12, flexDirection: "row", alrignItems: "center", flexWrap: "wrap", marginTop: 10, gap: 7 }}>
                ...
                <Pressable style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginHorizontal: 10 }}>
                    <Pressable style={{ width: 30, height: 30, borderRadius: 15, backgroundColor: "#282828", justifyContent: "center", alignItems: "center" }}>
                        <AntDesign name="arrowdown" size={20} color="white" />
                    </Pressable>

                    <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                        <MaterialCommunityIcons name="cross-bolnisi" size={24} color="white" />
                        <Pressable style={{ width: 60, height: 60, borderRadius: 35, justifyContent: "center", alignItems: "center", backgroundColor: "#282828" }}>
